...
<rect x="295" y="272" width="220" height="6" fill="#60a5fa" rx="3" opacity="0.8">
  ...
  <!-- Title -->
<text x="450" y="460" text-anchor="middle" fill="url(#accentGrad)" font-family="'Segoe UI', Arial, sans-serif" font-size="36" font-weight="800" filter="url(#glowEffect)">
<text x="450" y="490" text-anchor="middle" fill="#4b5563" font-family="'Segoe UI', Arial, sans-serif" font-size="16" font-weight="500">
<text x="450" y="510" text-anchor="middle" fill="#6b7280" font-family="'Segoe UI', Arial, sans-serif" font-size="13">
  <!-- Animated Cursor -->
